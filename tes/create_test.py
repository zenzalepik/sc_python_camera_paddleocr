...
File ini akan di-generate oleh create_test.py
"""

test_code = '''# Test Import Library - Object Distance Detection
import sys
import os
...
# Write the file
with open('test_import_library.py', 'w', encoding='utf-8') as f:
    f.write(test_code)

print("✓ File created: test_import_library.py")
