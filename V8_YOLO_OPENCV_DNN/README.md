# 🎯 Real-time Object Distance Detection with PaddleOCR

Aplikasi streaming real-time untuk deteksi object yang mendekat/menjauh dari kamera menggunakan **YOLOv8** dengan integrasi **PaddleOCR v5 Mobile** untuk deteksi plat nomor otomatis.

![Python](https://img.shields.io/badge/Python-3.8+-blue.svg)
![YOLO](https://img.shields.io/badge/YOLO-v8-purple.svg)
![PaddleOCR](https://img.shields.io/badge/PaddleOCR-v5%20Mobile-blue.svg)
...
### Parking System:
- 🅿️ **4-Phase Capture** - FASE 1-4 capture otomatis & manual
- 🅿️ **Loop Detector & Tap Card** - Trigger manual untuk simulasi parkir
- 🅿️ **Auto Save** - Simpan semua capture ke folder terstruktur

### PaddleOCR Integration:
- 🔍 **Auto OCR** - Jalankan OCR otomatis setelah parking session selesai
- 🔍 **Plat Nomor Detection** - Deteksi teks/plat nomor dari frame optimal
- 🔍 **Save Result** - Simpan hasil OCR ke JSON
- 🔍 **OCR Preview** - Tampilkan popup dengan hasil OCR
